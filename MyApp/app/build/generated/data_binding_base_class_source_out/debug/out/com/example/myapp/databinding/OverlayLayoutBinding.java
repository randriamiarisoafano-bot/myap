...
public final class OverlayLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final View captureZone;

  @NonNull
  public final Button startStopButton;

  private OverlayLayoutBinding(@NonNull FrameLayout rootView, @NonNull View captureZone,
      @NonNull Button startStopButton) {
  ...
  public static OverlayLayoutBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.capture_zone;
      View captureZone = ViewBindings.findChildViewById(rootView, id);
      if (captureZone == null) {
        break missingId;
      }
      ...
      return new OverlayLayoutBinding((FrameLayout) rootView, captureZone, startStopButton);
    }
